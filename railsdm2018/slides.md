...
継続してアプリケーションを改善し続けるために、より良い設計を考えるというのは大事なことだと思う。
...
ref. [似非サービスクラスの殺し方](https://speakerdeck.com/joker1007/number-ginzarb)
